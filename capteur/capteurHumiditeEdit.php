...
$id_capt = $_REQUEST['id'];
	...
	if (isset($_POST['modif'])) {
		...
		$sql = "UPDATE capteur_humid set Num_serie = ?, Description = ?, Endroit = ?, Etat = ?, Humid_max = ?, Humid_min = ?, Humid_reelle = ?,id_salle = ? WHERE id = ?";
		$q = $pdo->prepare($sql);
		$q->execute(array($nom,$description,$endroit,$etat,$humidmax,$humidmin,$humidreel,$id,$id_capt));
...
<head>
        ...
        <title>Modifier un capteur d'humidité</title>
                    ...
                    <div class="card">
					 	<div class="card-header card-default">
							...
							<?php 
								...
								$sql1 = "select * from capteur_humid where  id=".$id_capt;
                        ...
                        <?php 
							...
							$sql = "select * from capteur_humid where  id=$id_capt";
							foreach ($pdo->query($sql) as $row) 
							{
								...
								$endroit= $row['Endroit'];
								$etat= $row['Etat'];
								$hmdmax= $row['Humid_max'];
								$hmdmin= $row['Humid_min'];
								$hmdreel= $row['Humid_reelle'];
							...
							<div class="row">
										...
										<div class="col-md-4">
												<div class="form-group">
													...
													<select id="batiment_capteur" style="border-color:red;" class="form-control form-control-rounded">
											...
											<div class="col-md-4">
													<div class="form-group">
														<label>Etage</label>
														<select id="etage_capteur" style="border-color:red;" name ="etage_capteur" class="form-control form-control-rounded">
											...
											<div class="col-md-4">
													<div class="form-group">
														<label>Salle</label>
														<select id="salle_capteur" style="border-color:red;" name="salle_capteur" class="form-control form-control-rounded">
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" name="humidmin" value="<?php echo $hmdmin  ?>" class="form-control form-control-rounded">
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group">
										<label>Humidité maximale</label>
										<input type="text" name="humidmax" value="<?php  echo $hmdmax ?>" class="form-control form-control-rounded">
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group">
										<label>Humidité réelle</label>
										<input type="text" name="humidreel" value="<?php  echo $hmdreel ?>" class="form-control form-control-rounded">
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group">
