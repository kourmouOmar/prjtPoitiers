...
$id_capteur = $_REQUEST['val'];
$table =$_REQUEST['tab'];
$target="";
if ($table == "capteur_temperature") {$target="../capteur.php";}
if ($table == "capteur_humid") {$target="capteurHumidite.php";}
if ($table == "capteur_mouvement") {$target="capteurMvt.php";}
if ($table == "capteur_detecteur_incendie") {$target="capteurIncendie.php";}
...
<head>
    ...
    <body>
		...
		<section class="main-content">
			...
			<div class="card" style="width:50%;margin:auto;background-color:white">
							...
							<h1 style="text-align:center">Supprimer un capteur:</h1>
						<br>

						<form class="form-horizontal"  method="post">
							
							<p style="font-size:20pt;text-align:center">Vous êtes sur de supprimer ce capteur ?</p>
							<input type="hidden" name="id" value="<?php echo $id_etage;?>"/><br>
							<div class="form-actions" style="width:20%;margin:auto">
								<button type="submit" name="delete" class="btn btn-danger">Oui</button>
								<a class="btn" href="<?php echo $target?>">Non</a>
							</div>
							<br>
						</form>
					</div>
