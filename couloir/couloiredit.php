...
$id_couloir = $_REQUEST['val'];

$sql = "select * from couloir where  id=$id_couloir";
foreach ($pdo->query($sql) as $row) {
...
if (isset($_POST['modifier'])) {
	...
	$description =$_POST["description_couloir"];
	$etage_couloir = $_POST["etage_couloir"];

    $sql = "UPDATE couloir set nom = ?, description = ?,id_etage=? WHERE id = ?";
	$q = $pdo->prepare($sql);
	$q->execute(array($nom_couloir,$description,$etage_couloir,$id_couloir));
    $conn->query($sql);
...
<head>
    ...
    <title>Modifier le couloir</title>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						...
						<div class="card-header card-default">Modifierle couloir
							...
							<form method="post"  enctype="multipart/form-data">
								...
								<div class="col-md-6">
								    <div class="form-group">
										...
										<select id="batiment_salle" name='batiment_couloir' style="border-color:red;" class="form-control form-control-rounded ">
									...
									<div class="col-md-6">
										<div class="form-group">
											<label>Etage</label>
											<select id="etage_salle" name='etage_couloir' style="border-color:red;"class="form-control form-control-rounded">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group  ">
                                    	...
                                    	<input type="text"  name="nom_couloir" value="<?php echo $nom ?>" class="form-control form-control-rounded">
                                	</div>
								</div>
								...
								<div class="col-md-6">
									<div class="form-group  ">
                                    	...
                                    	<input type="text"  name="description_couloir" value="<?php echo $description ?>" class="form-control form-control-rounded">
                                	</div>
								</div>
