...
<?php
		if (isset($_POST['delete'])) {
			...
			$sql = "delete from climatiseur  WHERE id = ?";
			$q = $pdo->prepare($sql);
			$q->execute(array($id_climatiseur));
    ...
    <body>
		...
		<section class="main-content">
			...
			<div class="card" style="width:50%;margin:auto;background-color:white">
							...
							<h1 style="text-align:center">Supprimer un climatiseur:</h1>
						<br>

						<form class="form-horizontal"  method="post">
							
							<p style="font-size:20pt;text-align:center">Vous êtes sur de supprimer ce climatiseur ?</p>
							<input type="hidden" name="id" value="<?php echo $id_climatiseur;?>"/><br>
							<div class="form-actions" style="width:20%;margin:auto">
								<button type="submit" name="delete" class="btn btn-danger">Oui</button>
								<a class="btn" href="../climatiseur.php">Non</a>
							</div>
							<br>
						</form>
					</div>
