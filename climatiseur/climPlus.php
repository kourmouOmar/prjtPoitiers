...
<head>
        ...
        <title>Informations du climatiseur</title>
					...
					<div class="col-md-12">
                    	<div class="card">
					 		...
					 		<?php 
								...
								foreach ($pdo->query($sql) as $row) 
								{	$num_climatiseur= $row['Num_serie']; 
									$id_salle=$row['id_salle'];
								}

								echo "Détails du climatiseur : ".$num_climatiseur;
                        	?>
								 
							<p class="text-muted">Les informations complètes sur le climatiseur</p>
                        	</div>
                    	</div>
                 	</div>
            </div>
                ...
                <div class="col-sm-8">
                    <div class="card">
                        <div class="card-header sortable-title">
                        	<div class="card-header sortable-title">
                            	Détail du climatiseur:
                        	</div>
                        	<table class="table table-hover">

                            <thead>
                            <tr>
                                <th colspan="6" class="text-center">Climatiseur</th>
                            </tr>
                            <tr>
							<th>N° serie</th> <th>Description</th> <th>Endroit</th><th>Etat</th><th>Catégorie</th><th>Etat d'utilisation</th>
                            </tr>
                            </thead>
                            <tbody>
                        		...
                        		<?php 
                        			...
                        			$mk= "select * from climatiseur where  id=$id_climatiseur";
									...
									echo"<tr style='text-align:center'><td>".$num."</td>";
									echo"<td>".$desc."</td>";
									echo"<td>".$end."</td>";
									echo"<td>".$etat."</td>";
									echo"<td>".$cat."</td>";
