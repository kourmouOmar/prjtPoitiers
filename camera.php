   ...
   $password=$row['password'];
	...
	if (isset($_POST['ok'])) {
		...
		if($_POST['endroit_capteur'] == "batiment") 
		{
			...
			$sql = "INSERT INTO camera(Num_serie,Description,Endroit,Longitude,Latitude,adress_ip,exterieur_interieur,id_batiment) values(?,?,?,?,?,?,?,?)";
			$q = $pdo->prepare($sql);
			$q->execute(array($num_serie,$description,$endroit,$Longitude,$Latitude,$adress_ip,$ext_int,$id_batiment));
		...
		if($_POST['endroit_capteur'] == "etage") 
		{
			...
			$sql = "INSERT INTO camera(Num_serie,Description,Endroit,Longitude,Latitude,adress_ip,exterieur_interieur,id_etage) values(?,?,?,?,?,?,?,?)";
			$q = $pdo->prepare($sql);
			$q->execute(array($num_serie,$description,$endroit,$Longitude,$Latitude,$adress_ip,$ext_int,$id_etage));
			header("Location: camera.php");
		}
		...
		if($_POST['endroit_capteur'] == "salle") 
		{
			...
			$sql = "INSERT INTO camera(Num_serie,Description,Endroit,Longitude,Latitude,adress_ip,exterieur_interieur,id_salle) values(?,?,?,?,?,?,?,?)";
			$q = $pdo->prepare($sql);
			$q->execute(array($num_serie,$description,$endroit,$Longitude,$Latitude,$adress_ip,$ext_int,$id_salle));
			header("Location: camera.php");
		}
		...
		if($_POST['endroit_capteur'] == "couloir") 
		{
			...
			$sql = "INSERT INTO camera(Num_serie,Description,Endroit,Longitude,Latitude,adress_ip,exterieur_interieur,id_couloir) values(?,?,?,?,?,?,?,?)";
			$q = $pdo->prepare($sql);
			$q->execute(array($num_serie,$description,$endroit,$Longitude,$Latitude,$adress_ip,$ext_int,$id_couloir));
			header("Location: camera.php");
		}
		...
		if($_POST['endroit_capteur'] == "escalier") 
		{
			...
			$sql = "INSERT INTO camera(Num_serie,Description,Endroit,Longitude,Latitude,adress_ip,exterieur_interieur,id_escalier) values(?,?,?,?,?,?,?,?)";
			$q = $pdo->prepare($sql);
			$q->execute(array($num_serie,$description,$endroit,$Longitude,$Latitude,$adress_ip,$ext_int,$id_escalier));
			header("Location: camera.php");
		}
		...
		if($_POST['endroit_capteur'] == "zone") 
		{
			...
			$sql = "INSERT INTO camera(Num_serie,Description,Endroit,Longitude,Latitude,adress_ip,exterieur_interieur,id_zone) values(?,?,?,?,?,?,?,?)";
			$q = $pdo->prepare($sql);
			$q->execute(array($num_serie,$description,$endroit,$Longitude,$Latitude,$adress_ip,$ext_int,$id_zone));
			header("Location: camera.php");
		}
                ...
                <div class="nano-content sidebar-nav">
                    ...
                    <ul class="metisMenu nav flex-column" id="menu">
						...
						<li class="nav-item  active">
                            <a class="nav-link"  href="camera.php" aria-expanded="false">
					 	...
					 	<div class="card-header card-default">
							<div class="float-right mt-10">
								<a href="javascript: void(0);"  class="btn btn-primary btn-rounded box-shadow btn-icon" onclick="$('.capttemp').toggle()">
									<i class="fa fa-plus"></i> Ajouter camera
								</a>
                            </div>
							Les cameras
							<p class="text-muted">Liste des cameras </p>
                        </div>
                        ...
                        <table id="datatable1" class="table table-striped dt-responsive nowrap table-hover">
                            ...
                            <tbody>
                                	...
                                	<?php 
										...
										echo '<td>'. $row['exterieur_interieur'] . '</td>';
										...
										echo "
                                        	...
                                        	<button type='button'    class='btn btn-sm btn-default' >
												<a href='camera/cameraplus.php?val=".$row['id']."'  >
												<i class='fa fa-plus'></i>
												</a>
											</button>
											<button type='button' class='btn btn-sm btn-success'>
												<a href='camera/cameraEdit.php?val=".$row['id']."'>
												<i class='fa fa-edit'></i>
												</a>
											</button>
											<button type='button' class='btn btn-sm btn-danger'>
												<a href='camera/cameraDelet.php?val=".$row['id']."'>
