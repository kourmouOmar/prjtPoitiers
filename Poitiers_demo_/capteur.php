                        ...
                        <table id="datatable1" class="table table-striped dt-responsive nowrap table-hover">
                            <thead>
                            	<tr>
                                    ...
                                    <th class="text-center">
                                        <strong>températeur minimale</strong>
                                    </th>
                                    <th class="text-center">
                                        <strong>températeur maximale</strong>
                                    </th>
                                    <th class="text-center">
                            ...
                            <tbody>
                                	...
                                	<?php 
                                    	$sql = "select * from  capteur_temperature";
                                    	foreach ($pdo->query($sql) as $row) 
										{
										echo '<tr>';
										...
										echo "
                                        	...
                                        	<button type='button' class='btn btn-sm btn-default'>
                                        		<a href='capteur/capteurplus.php?val=".$row['id']."&tab=capteur_temperature'  >
