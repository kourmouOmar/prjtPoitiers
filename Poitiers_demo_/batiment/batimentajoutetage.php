...
if ($conn->connect_error) {
	...
	if (isset($_POST['ajouter'])) {
		...
		$nom =$_POST["nom_etage"];
		$description =$_POST["description_etage"];
...
if ($conn->query($sql) === TRUE) {
	...
	$q = $pdo->prepare($sql);
	$q->execute(array($nom,$description,$id,$last_id));
	echo "<script> document.getElementById('.succajou').innerHTML = 'ajouter avec success';</script>";
	...
	/*	$sql1 = "INSERT INTO etage(nom,Description,id_batiment,id_plan) values(?,?,?,?)";
		$q = $pdo->prepare($sql1);
		$q->execute(array($nom,$description,$id,$id_plan));

        echo "<p class='btn-primary'> insertion avec success</p>";
                ...
                <div class="nano-content sidebar-nav">
                    ...
                    <ul class="metisMenu nav flex-column" id="menu">
                        ...
                        <li class="nav-item ">
                            ...
                            <i class="fa fa-codepen"></i> 
                            <span class="toggle-none">les clim </span>
                            </a>
                        </li>
                    ...
                    <div class="card">
                     ...
                     <form method="post"  enctype="multipart/form-data">
							<div class="row">
								...
								<div class="col-md-6">
                                   <div class="form-group">
                                    	<label>description bâtiment</label>
							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										<input type="submit" name="ajouter" value="ajouter étage" width="500px" class="btn btn-sm btn-success">
									</div>
								</div>
							</div>
