...
if (isset($_POST['ok'])) {
		...
		$sql = "INSERT INTO  image( nom, path)VALUES ('$nom', '$path')";
...
if ($conn->query($sql) === TRUE) {
   ...
   $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
	$sql = "INSERT INTO batiment(nom,Description,id_plan) values(?,?,?)";
	$q = $pdo->prepare($sql);
	$q->execute(array($nom,$description,$last_id));	
                                ...
                                <table id="datatable1" class="table table-striped dt-responsive nowrap table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">
                                                <strong>Ajouter un étage</strong>
                                            </th>
                                    ...
                                    $sql = "select * from batiment";
                                     ...
                                     ?>
                                        	<td><button class="btn btn-sm btn-secondy ">Plan</button></td>
                                        	<td>
                                        		<button class="btn btn-sm btn-secondy ">
                                        		<?php  echo "<a href='batiment/batimentajoutetage.php?val=".$row['id']."'>ajouter étage</a>	"; ?>
                                            ...
                                            <td class="text-center">
												...
												<a href='batiment/batimentplus.php?val=".$row['id']."'  >
												<i class='fa fa-plus'></i>
												</a>
												</button>";?>
                                                <?php echo"
												<button type='button'    class='btn btn-sm btn-success' >
												<a href='batiment/batimentedit.php?val=".$row['id']."'  >
												<i class='fa fa-edit'></i>
												</a>
												</button>";?>
												<?php echo"
												<button type='button'    class='btn btn-sm btn-danger' >
												<a href='batiment/batimentdelet.php?val=".$row['id']."'  >
