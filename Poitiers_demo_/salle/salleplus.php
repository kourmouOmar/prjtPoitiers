...
<head>
        ...
        <title>Informations sur salle</title>
					...
					<div class="col-md-12">
                    	<div class="card">
					 		...
					 		<?php 
								...
								echo "Salle : $nom_salle / $nom_etage / $nom_bati ";
                        	?>
                ...
                <div class="col-sm-6">
                    <div class="card">
                        <div class="card-header sortable-title">
                            ...
                            <thead>
                            <tr>
                                <th colspan="3" class="text-center">Capteur</th>
                            </tr>
                            <tr>
                                <th>Nom</th><th>Endroit</th><th>Catégorie</th>
                            </tr>
                            </thead>
                            <tbody>
                        	...
                        	$mk= "select * from capteur where  id_salle=$id_salle";
                        			foreach ($pdo->query($mk) as $row) {
                        				$id_cat=$row['id_categorie'];
                        				$num=$row['Num_serie'];
                        				$end=$row['endroit'];
                        				$sq= "select * from categorie_capteur where  id=$id_cat";
                         ...
                         <div class="card-header sortable-title">
                            ...
                            <thead>
                            <tr>
                                <th colspan="3" class="text-center">climatiseur</th>
                            </tr>
                            <tr>
                                <th>Nom</th><th>Endroit</th><th>Captécorie</th>
                            </tr>
                            </thead>
                            <tbody>
                        		...
                        		<?php 
                        			...
                        			$mk1= "select * from climatiseur where  id_salle=$id_salle";
                        			foreach ($pdo->query($mk1) as $row) {
                        				$cat=$row['categorie'];
                        				$num=$row['Num_serie'];
                        				$end=$row['endroit'];
            ...
            <div class="row w-no-padding margin-b-30 card" style="padding:20px">
            	<div class="col-md-12">
                    ...
                    <div class="row">
                    		...
                    		$sql10 = "select * from image where  id=$id_image";
                    		...
                    		?>
                    		<div class="col-md-4">
            			<img src="<?php echo" ../plan/$path" ?>" width="300px" height="300px">
							</div>
							<div class="col-md-6">
                    		<p class="margin-b-0">
