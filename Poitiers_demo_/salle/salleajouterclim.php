...
$id_salle = $_REQUEST['val'];
	...
	if (isset($_POST['ajouter'])) {
		...
		$num_calim =$_POST["num_capt"];
		//$categorie_capt =$_POST["categorie_capt"];
		$endroit =$_POST["endroit"];
		$etat =$_POST["etat"];

   		$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
		$sql = "INSERT INTO climatiseur(Num_serie,endroit,etat,id_salle) values(?,?,?,?)";
		$q = $pdo->prepare($sql);
		$q->execute(array($num_clim,$endroit,$etat,$id_salle ));
               ...
               <div class="row">
                    ...
                    <div class="card">
					 	<div class="card-header card-default">
							Ajouter un climatiseur dans la salle :<?php  echo "$num  // $numm // $nom"; ?>
                     ...
                     <form method="post"  >
                     		<div class="row">
                     			...
                     			<div class="col-md-4 ">
                     				<div class="form-group  ">
                                    	<label>Categorie du climatiseur</label>
                                    	<select name='categorie_capt' class="form-control form-control-rounded">
                                    		<option>Programmable</option>
                                    		<option>Non programmable</option>
                                    	</select>
                                	</div>
                     			</div>
                     		</div>
							<div class="row">
								<div class="col-md-6">
									<!-- <div class="form-group  ">
                                    	<label>Némero du serie</label>
                                    	<input type="text"  name="num_clim" value="<?php  echo "$n" ?>" class="form-control form-control-rounded">
                                	</div> -->
								</div>
								<div class="col-md-6">
									<div class="form-group  ">
                                    	<!-- <label>categorie du capteur</label>
                                    	<select name='categorie_capt' class="form-control form-control-rounded">
                                    		<?php 
            //                         			$sql = "select * from categorie_capteur ";
												// foreach ($pdo->query($sql) as $row) 
												// {
								...
								<div class="col-md-6">
									<!-- <div class="form-group  ">
                                    	<label>endroit</label>
                                    	<input type="text" name="endroit" value="" class="form-control form-control-rounded">
                                	</div> -->
								</div>
							</div>
							<div class="row">
								...
								<div class="col-md-6">
                                   <!-- <div class="form-group">
                                    	<label>etat</label>
                                    	<input type="text"  name="etat" value="<?php  echo $d  ?>" class="form-control form-control-rounded">
                                	</div> -->
								</div>
							...
							<div class="row">
								...
								<div class="col-md-12" >
									<div class="form-group">
										<input type="submit" name="ajouter" value="Ajouter un climatiseur"  class="btn btn-sm btn-success">
									</div>
								</div>
							</div>
