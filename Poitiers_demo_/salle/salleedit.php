...
<?php
	//echo $id;
		...
		$nom= $row['nom'] ;
		$etat= $row['etat'];
		$nbr_port= $row['nbr_port'];
		$nbr_fent= $row['nbr_fent'];	
		$categorie_salle = $row['categorie_salle'];
		$etage =$row['etage'];

							
		$sql = "UPDATE salle set Num_salle = ?, id_categorie = ?, Etat = ? , nbr_fenetres = ? , nbr_portes = ? , id_etage = ? WHERE id = ?";
		$q = $pdo->prepare($sql);
		$q->execute(array($nom,$categorie_salle,$etat,$nbr_fent,$nbr_fent,$id_etage));
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group  ">
                                    	...
                                    	<input type="text" name="nom" value="<?php  echo $num_salle ?>" class="form-control form-control-rounded">
                                	</div>
								</div>
								<div class="col-md-6">
                                   <div class="form-group">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group  ">
                                    	...
                                    	<input type="text" name="nbr_port" value="<?php  echo $nbr_port ?>" class="form-control form-control-rounded">
                                	</div>
								</div>
								<div class="col-md-6">
                                   <div class="form-group">
                                    	<label>Nombres de fenêtres</label>
                                    	<input type="text" name="nbr_fent" value="<?php echo $nbr_fent  ?>" class="form-control form-control-rounded">
                                	</div>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-md-6">
                                   <div class="form-group">
                                   		<label>Etage</label>
                                    	<select name='etage' class="form-control form-control-rounded">
                                    	<?php 
                                    		$sql1 = "select * from etage ";
