...
$id_capt = $_REQUEST['val'];
	...
	if (isset($_POST['modif'])) {
		...
		$sql = "UPDATE capteur_temperature set Num_serie = ?, Description = ?, Endroit = ?, Etat = ?, Temp_max = ?, Temp_min = ?, Temp_reelle = ?,id_salle = ? WHERE id = ?";
		$q = $pdo->prepare($sql);
		$q->execute(array($nom,$description,$endroit,$etat,$tempmax,$tempmin,$tempreel,$id_salle,$id_capt));
