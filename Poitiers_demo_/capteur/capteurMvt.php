...
<head>
        ...
        <title>Capteurs Mouvement</title>
						...
						<div class="row">
							...
							<div class="col-md-4">
									<div class="form-group">
										...
										<select name="id_batiment" class="form-control form-control-rounded">
												<?php 
							...
							<div class="col-md-4">
									<div class="form-group">
										<label>Etage</label>
										<select name="id_etage" class="form-control form-control-rounded">
										<?php 
