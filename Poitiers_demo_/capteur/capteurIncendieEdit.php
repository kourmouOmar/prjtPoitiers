...
$id_capt = $_REQUEST['val'];
	...
	if (isset($_POST['modif'])) {
		...
		$etat =$_POST['etat'];
		$etatincendie =$_POST['etatincendie'];
		$id_salle=$_POST['id_salle'];

		$sql = "UPDATE capteur_detecteur_incendie set Num_serie = ?, Description = ?, Endroit = ?, Etat = ?, etat_mouvement = ?,id_salle = ? WHERE id = ?";
		$q = $pdo->prepare($sql);
		$q->execute(array($nom,$description,$endroit,$etat,$etatincendie,$id_salle,$id_capt));
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group  ">
                                    	...
                                    	<input type="text" name="etatincendie" value="<?php  echo $etatincendie ?>" class="form-control form-control-rounded">
                                	</div>
								</div>
								<div class="col-md-6">
                                   <div class="form-group">
