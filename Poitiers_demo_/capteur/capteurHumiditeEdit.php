...
$id_capt = $_REQUEST['val'];
	...
	if (isset($_POST['modif'])) {
		...
		$hmdmax= $_POST['Humid_max'];
		$hmdmin= $_POST['Humid_min'];
		$hmdreel= $_POST['Humid_reelle'];


		$id_salle=$_POST['id_salle'];

		$sql = "UPDATE capteur_humudité set Num_serie = ?, Description = ?, Endroit = ?, Etat = ?, Humid_max = ?, Humid_min = ?, Humid_reele = ?,id_salle = ? WHERE id = ?";
		$q = $pdo->prepare($sql);
		$q->execute(array($nom,$description,$endroit,$etat,$hmdmax,$hmdmin,$hmdreel,$id_salle,$id_capt));
             ...
             <div class="row">
                    ...
                    <div class="card">
					 	<div class="card-header card-default">
							Capteur  :
							<?php 
								$sql1 = "select * from capteur_humudité where  id=$id_capt";
                        ...
                        <?php 
							...
							$sql = "select * from capteur_humudité where  id=$id_capt";
                     ...
                     <form method="post"  >
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group  ">
                                    	<label>hmidité max</label>
                                    	<input type="text" name="hmdmax" value="<?php  echo $hmdmax ?>" class="form-control form-control-rounded">
                                	</div>
								</div>
								<div class="col-md-6">
                                   <div class="form-group">
                                    	<label>humidité min</label>
                                    	<input type="text" name="hmdmin" value="<?php echo $hmdmin  ?>" class="form-control form-control-rounded">
                                	</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group  ">
                                    	<label>humidité reele </label>
                                    	<input type="text" name="hmdreel" value="<?php  echo $hmdreel ?>" class="form-control form-control-rounded">
                                	</div>
								</div>
								<div class="col-md-6">
                                   <div class="form-group">
