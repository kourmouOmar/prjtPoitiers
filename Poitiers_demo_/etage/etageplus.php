...
<head>
    ...
    <body>
        ...
        <section class="main-content">
					...
					<div class="col-md-12">
                    	<div class="card">
					 		<div class="card-header card-default">
								...
								echo "Etage : $nom_batiment / $nom_etage";
                        	?>
            ...
            <div class="row w-no-padding margin-b-30 card" style="padding: 30px;">
            	<div class="row">
            		...
            		<div class="col-md-6">
            			...
            			?>
            			<img src="<?php echo" ../plan/$path" ?>" width="500px">
            		</div>
            		<div class="col-md-6">
            			<p class="margin-b-0">
