            ...
            <div class="row w-no-padding margin-b-30">
             ...
             <div class="row">
                    ...
                    <div class="card">
						...
						<p class="text-muted">Modifier les informations que vous voulez</p>
                     ...
                     <form method="post"  >
							<div class="row">
								...
								<div class="col-md-6">
                                   <div class="form-group">
                                    	<label>Déscription de l'étage</label>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group  ">
                                    	...
                                    	<input type="text" name="nom_batiment" value="<?php  echo $nom_batiment ?>" class="form-control form-control-rounded">
                                	</div>
								</div>
								<div class="col-md-6">
                                   <div class="form-group">
                                    	<label>Description du batiment</label>
                                    	<input type="text" name="description_batiment" value="<?php  echo $des_batiment  ?>" class="form-control form-control-rounded">
                                	</div>
								</div>
							</div>
							<div class="row">
