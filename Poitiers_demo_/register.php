<?php 
  ...
  document.getElementById(".errorMessage").innerHTML = "<h1>User name or Password is incorrect</h1>";
  </script>';
    }
                    ...
                    <div class="row justify-content-center">
                        <div class="col-4">
                            <input type="submit" name="ok" class="btn btn-block btn-primary btn-rounded box-shadow mt-10" value="Valider">
                                    ...
                                    <a href="index.html" class="btn btn-block btn-success btn-rounded box-shadow">Se connecter</a>
