<?php  include 'DB.php'; $pdo = Database::connect();
	if (isset($_POST['ok'])) {
		...
		$sql = "INSERT INTO climatiseur(Num_serie,Description,endroit,etat,categorie,id_salle) values(?,?,?,?,?,?)";
		$q = $pdo->prepare($sql);
		$q->execute(array($nom,$description,$endroit,$etat,$cat,$id_salle));
							...
							<div class="row">
								<div class="col-md-4">
									<div class="form-group  ">
                                    	...
                                    	<select name="cat" class="form-control form-control-rounded">
                        ...
                        <div class="card-body">
                                <table id="datatable1" class="table table-striped dt-responsive nowrap table-hover">
                                    ...
                                    <tbody>
										...
										echo '<td>'.$end.'<br> ->'. $num_sal."<br> ->".$etag."<br> ->".$bat. '</td>';
