...
$id_clm = $_REQUEST['val'];
	...
	if (isset($_POST['modif'])) {
		...
		$sql = "UPDATE climatiseur set Num_serie = ?, Description = ?, endroit = ?, etat = ?, categorie = ?,id_salle = ? WHERE id = ?";
		$q = $pdo->prepare($sql);
		$q->execute(array($nom,$description,$endroit,$etat,$categorie,$id_salle,$id_clm));
             ...
             <div class="row">
                    ...
                    <div class="card">
					 	<div class="card-header card-default">
							Capteur  :
							<?php 
								$sql1 = "select * from climatiseur where  id=$id_clm";
                        ...
                        <?php 
							...
							$sql = "select * from climatiseur where  id=$id_clm";
                     ...
                     <form method="post"  >
							<div class="row">
								...
								<div class="col-md-6">
                                   <div class="form-group">
                                    	<label>description climatiseur</label>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group  ">
                                    	...
                                    	<input type="text" name="categorie" value="<?php  echo $categorie ?>" class="form-control form-control-rounded">
                                	</div>
								</div>
								<div class="col-md-6">
                                   <div class="form-group">
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<a href="../climatiseur.php" class="btn btn-sm btn-default" width="500px">reteur</a>	
