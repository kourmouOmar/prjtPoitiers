               ...
               <div class="container">
					<div class="span10 offset1">
						...
						<form class="form-horizontal"  method="post">
							<input type="hidden" name="id" value="<?php echo $id_clm;?>"/>
							<p class="alert alert-error">Are you sure to delete?</p>
							<div class="form-actions">
								<button type="submit" name="delete" class="btn btndanger">Yes</button>
								<a class="btn" href="../climatiseur.php">No</a>
							</div>
						</form>
					</div>
				</div> 
