...
$id = $_REQUEST['val'];
	...
	$sql1 = "select * from plan where  id=$id_plan";
...
<head>
        ...
        <title>Informations du bâtiment</title>
					...
					<div class="col-md-12">
                    	<div class="card">
					 		<div class="card-header card-default">
								...
								<p class="text-muted">Informations complètes sur le bâtiment:</p>
                        	</div>
									...
									<table width=100%>
										...
										<tbody>
											<tr>
												...
												<?php 
													$sql1 = "select * from plan where  id=$id_plan";
													foreach ($pdo->query($sql1) as $row) {$path= $row['path'] ;}
										
												?>
													<img src="../plan/<?php echo $path; ?>" alt="" width="300px">
												</td>
											</tr>
										</tbody>
									</table>
