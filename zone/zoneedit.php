...
$id_zone = $_REQUEST['val'];
    ...
    $sql = "select * from zone where id=$id_zone";
    foreach ($pdo->query($sql) as $row) 
    {
    $id=$row['id'];
    $nom =$row['nom'];	
    ...
    if (isset($_POST['modifier'])) 
    {
        ...
        $sql = "UPDATE zone set nom = ?,description = ?  WHERE id = ?";
        $q = $pdo->prepare($sql);
        $q->execute(array($nom_zone,$description,$id_zone));
            ...
            <div class="container-fluid">	
                ...
                <div class="card">
                     ...
                     <div class="card-header card-default">
                        Les zones
                        <p class="text-muted">Modifier une zone</p>
                    </div>
                    ...
                    <div class="card-body escalier" >
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card-header card-default">
                                    <p class="text-muted">Modifier les informations du zone que vous voullez changer:</p>
                                </div>
