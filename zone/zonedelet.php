...
$id_zone = $_REQUEST['val'];

if (isset($_POST['delete'])) {
										
    $sql = "delete from zone  WHERE id = ?";
    $q = $pdo->prepare($sql);
    $q->execute(array($id_zone));
               ...
               <div class="container"  style="width:50%;margin:auto;background-color:white"><br>
					<div class="span10 offset1">
						...
						<form class="form-horizontal"  method="post">
							...
							<p style="font-size:20pt;text-align:center">Vous êtes sur de supprimer cet zone ?</p>
							...
							<div class="form-actions" style="width:20%;margin:auto">
								...
								<a class="btn" href="../zone.php">Non</a>
							</div>
							<br>
						</form>
					</div>
