...
if (isset($_POST['ok'])) {
    ...
    $sql = "INSERT INTO  zone(nom, description)VALUES ('$nom_zone  ', '$description')";
	$conn->query($sql);
                    ...
                    <div class="card">
					 	<div class="card-header card-default">
							<div class="float-right mt-10">
								<a href="javascript: void(0);"  onclick="$('.batt').toggle()" class="btn btn-primary btn-rounded box-shadow btn-icon"><i class="fa fa-plus"></i> Ajouter un zone</a>
                            </div>
							Les zones
							<p class="text-muted">Liste des zones</p>
                        </div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group  ">
                                    	...
                                    	<input type="text"  name="nom_zone" class="form-control form-control-rounded">
                                	</div>
								</div>

								<div class="col-md-6">
									<div class="form-group  ">
                                    	<label>Description du zone</label>
                        ...
                        <div class="card-body">
                                <table id="datatable1" class="table table-striped dt-responsive nowrap table-hover">
                                    ...
                                    <?php 
										...
										echo '<td>'. $row['id'] . '</td>'; $id_zone= $row['id'] ;
										echo '<td>'. $row['nom'] . '</td>';
                                    ...
                                    ?>
                                        ...
                                        <td class="text-center">
												...
												<a href='zone/zoneplus.php?val=".$id_zone."'  >
												<i class='fa fa-plus'></i>
												</a>
												</button>";?>
                                                <?php echo"
												<button type='button'    class='btn btn-sm btn-success' >
												<a href='zone/zoneedit.php?val=".$id_zone."'  >
												<i class='fa fa-edit'></i>
												</a>
												</button>";?>
												<?php echo"
												<button type='button'    class='btn btn-sm btn-danger' >
												<a href='zone/zonedelet.php?val=".$id_zone."'  >
