...
if (isset($_POST['delete'])) {
    ...
    $sql = "delete from escalier  WHERE id = ?";
    $q = $pdo->prepare($sql);
    $q->execute(array($id_escalier));
...
<head>
        ...
        <title>Supprimer un escalier</title>
			...
			<br><br><br><br><br><br><br>
               <div class="container"  style="width:50%;margin:auto;background-color:white"><br>
					<div class="span10 offset1">
							...
							<h1 style="text-align:center">Supprimer un escalier:</h1>
						<br>

						<form class="form-horizontal"  method="post">
							
							<p style="font-size:20pt;text-align:center">Vous êtes sur de supprimer cet escalier ?</p>
							<input type="hidden" name="id" value="<?php echo $id_escalier;?>"/><br>
							<div class="form-actions" style="width:20%;margin:auto">
								<button type="submit" name="delete" class="btn btn-danger">Oui</button>
								<a class="btn" href="../escalier.php">Non</a>
							</div>
							<br>
						</form>
					</div>
