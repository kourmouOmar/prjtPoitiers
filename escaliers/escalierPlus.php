...
<head>
        ...
        <title>Informations de l'escalier</title>
            ...
            <div class="nano">
                <div class="nano-content sidebar-nav">
                    ...
                    <ul class="metisMenu nav flex-column" id="menu">
						...
						<li class="nav-item ">
							<a class="nav-link"  href="../couloir.php" aria-expanded="true">
							...
							<div class="col-md-12">
								<div class="card">
									<div class="card-header card-default">
										...
										echo "$etage_bas <-> $etage_haut - $nom_escalier";
									?>
										<p class="text-muted">Informations complètes sur l'escalier:</p>
									</div>
								</div>
							</div>
					</div>
